...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LotsOfReplies = channel.unary_stream(
                '/hello.Greeter/LotsOfReplies',
                request_serializer=Example__pb2.HelloRequest.SerializeToString,
                response_deserializer=Example__pb2.HelloReply.FromString,
                )
        self.LotsOfGreetings = channel.stream_unary(
                '/hello.Greeter/LotsOfGreetings',
                request_serializer=Example__pb2.HelloRequest.SerializeToString,
                response_deserializer=Example__pb2.HelloReply.FromString,
                )
...
class Greeter(object):
    ...
    def LotsOfReplies(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/hello.Greeter/LotsOfReplies',
            Example__pb2.HelloRequest.SerializeToString,
            Example__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def LotsOfGreetings(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/hello.Greeter/LotsOfGreetings',
            Example__pb2.HelloRequest.SerializeToString,
            Example__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
